      ...
      <Card className="w-full max-w-md glass-card border-[rgba(0,245,255,0.15)] relative overflow-hidden">
        ...
        <CardContent className="relative z-10">
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <Button
              type="submit"
              className="w-full h-12 rounded-xl font-bold text-white bg-gradient-to-r from-[#00f5ff] to-[#00c2cc] hover:brightness-110 border-0 shadow-[0_12px_28px_rgba(0,245,255,0.25)] hover:shadow-[0_16px_36px_rgba(0,245,255,0.35)] transition-all text-[#050810]"
              disabled={loading}
            >
              {loading ? '登录中...' : '登录'}
            </Button>

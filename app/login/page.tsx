...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setLoading(true)
    try {
      const payload = tab === 'password' ? { phone, password, type: 'password' } : { phone, code, type: 'sms' }
    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative">
      ...
      <Card className="w-full max-w-md glass-card border-[rgba(0,245,255,0.15)] relative overflow-hidden">
        ...
        <CardHeader className="text-center relative z-10 pt-10">
          ...
          <CardDescription className="text-[rgba(180,200,255,0.6)]">欢迎登录速凌电竞平台</CardDescription>
        </CardHeader>
        <CardContent className="relative z-10">
          ...
          <div className="mt-6 text-center text-xs text-[rgba(180,200,255,0.45)]">
            <p>管理员：13800138000 / 123456</p>
            <p>用户/打手：13800138001~08 / 123456</p>
          </div>
        </CardContent>
      </Card>
    </div>
